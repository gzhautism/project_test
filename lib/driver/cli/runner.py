...
import warnings
from io import open
from lib.driver.core.api import G, auto_setup, log
from lib.driver.core.settings import Settings as ST
from lib.driver.utils.compat import decode_path, script_dir_name, script_log_dir
...
def run_script(parsed_args, testcase_cls=AutotestCase):
    global args  # make it global deliberately to be used in AutotestCase & test scripts
    args = parsed_args
