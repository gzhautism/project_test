...
from lib.driver.core.device import Device
from lib.driver.core.android.ime import YosemiteIme
from lib.driver.core.android.constant import CAP_METHOD, TOUCH_METHOD, IME_METHOD, ORI_METHOD, \
    SDK_VERISON_ANDROID10
from lib.driver.core.android.adb import ADB

from lib.driver.core.android.rotation import RotationWatcher, XYTransformer
from lib.driver.core.android.recorder import Recorder
from lib.driver.core.android.touch_methods.touch_proxy import TouchProxy
from lib.driver.core.error import AdbError, AdbShellError
from lib.driver.core.android.cap_methods.screen_proxy import ScreenProxy

# Compatible with old code
from lib.driver.core.android.cap_methods.minicap import Minicap  # noqa
from lib.driver.core.android.cap_methods.javacap import Javacap  # noqa
from lib.driver.core.android.touch_methods.minitouch import Minitouch  # noqa
from lib.driver.core.android.touch_methods.maxtouch import Maxtouch  # noqa
...
class Android(Device):
    ...
    def touch_proxy(self):
        ...
        Module: :py:mod:`driver.core.android.touch_methods.touch_proxy.TouchProxy`
    ...
    def cap_method(self, name):
        ...
        """
        warnings.warn("No need to manually specify cap_method, driver will automatically specify a suitable screenshot method, when driver>=1.1.2")
    ...
    def screen_proxy(self, cap_method):
        ...
        Args:
            cap_method: "MINICAP" or :py:mod:`driver.core.android.cap_methods.minicap.Minicap` object
        ...
        Examples:
            ...
            >>> from lib.driver.core.android.cap_methods.minicap import Minicap
    ...
    def get_deprecated_var(self, old_name, new_name):
        ...
        When the driver version number>=1.1.2, the call device.minicap/device.javacap is removed, and relevant compatibility is made here, and DeprecationWarning is printed

        autotest版本号>=1.1.2时，去掉了device.minicap/device.javacap这样的调用，在此做了相关的兼容，并打印DeprecationWarning
    ...
    def check_app(self, package):
        ...
        Raises:
             AutotestError: raised if package is not found
    ...
    def install_app(self, filepath, replace=False, install_options=None):
        ...
        Args:
            ...
            install_options: _list of options, default is []
    ...
    def pinch(self, center=None, percent=0.5, duration=0.5, steps=5, in_or_out='in'):
        ...
        Raises:
            TypeError: An error occurred when center is not a _list/tuple or None
    ...
    def swipe_along(self, coordinates_list, duration=0.8, steps=5):
        ...
        Args:
            coordinates_list: _list of coordinates: [(x1, y1), (x2, y2), (x3, y3)]
            duration: time interval for swipe duration, default is 0.8
            steps: size of swipe step, default is 5
    ...
    def start_recording(self, max_time=1800, bit_rate_level=1, bit_rate=None):
        ...
        Examples:
            ...
            >>> from driver.core.api import connect_device, sleep
