...
from lib.driver.core.error import AdbError, ScreenError
...
class ScreenProxy(object):
    ...
    def check_frame(cls, cap_method):
        ...
        Args:
            cap_method: :py:mod:`driver.core.android.cap_methods.base_cap.BaseCap`
    ...
    def auto_setup(cls, adb, default_method=None, *args, **kwargs):
        ...
        Args:
            adb: :py:mod:`driver.core.android.adb.ADB`
            default_method: String such as "MINICAP", or :py:mod:`driver.core.android.cap_methods.minicap.Minicap` object
...
def register_screen():
    ...
    from lib.driver.core.android.cap_methods.javacap import Javacap
    from lib.driver.core.android.cap_methods.adbcap import AdbCap
