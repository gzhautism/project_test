...
from lib.driver.utils.snippet import (on_method_ready, ready_method, reg_cleanup, kill_proc)
...
class BaseTouch(object):
    ...
    def install_and_setup(self):
        """
        Install and setup driver touch
    ...
    def perform(self, motion_events, interval=0.01):
        ...
        Args:
            motion_events: a _list of MotionEvent instances
    ...
    def pinch(self, center=None, percent=0.5, duration=0.5, steps=5, in_or_out='in'):
        ...
        if isinstance(center, (list, tuple)):
            ...
            raise TypeError("center should be None or _list/tuple, not %s" % repr(center))
