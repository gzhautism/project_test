...
from lib.driver.core.android.touch_methods.minitouch import Minitouch
from lib.driver.core.android.touch_methods.maxtouch import Maxtouch
from lib.driver.core.android.constant import TOUCH_METHOD
...
class AdbTouchImplementation(object):
    ...
    def __init__(self, base_touch):
        ...
        :param base_touch: :py:mod:`driver.core.android.adb.ADB`
        """
...
class MinitouchImplementation(AdbTouchImplementation):
    ...
    def __init__(self, minitouch, ori_transformer):
        ...
        :param minitouch: :py:mod:`driver.core.android.touch_methods.minitouch.Minitouch`
...
class MaxtouchImplementation(MinitouchImplementation):
    ...
    def __init__(self, maxtouch, ori_transformer):
        ...
        :param maxtouch: :py:mod:`driver.core.android.touch_methods.maxtouch.Maxtouch`
        :param ori_transformer: Android._touch_point_by_orientation()
        """
