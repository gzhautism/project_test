...
from lib.driver.utils.apkparser import APK
    ...
    def _install_apk_upgrade(self, apk_path, package):
        ...
        if installed_version is None or apk_version > int(installed_version):
            ...
            try:
                ...
                warnings.warn("Yosemite.apk update failed, please try to reinstall manually(driver/core/android/static/apks/Yosemite.apk).")
