# -*- coding: utf-8 -*-
"""
This module contains the driver Core APIs.
"""
import os
import time
...
from lib.driver.core.cv import Template, loop_find, try_log_screen
from lib.driver.core.error import TargetNotFoundError
from lib.driver.core.helper import (G, delay_after_operation, import_device_cls,
                                    logwrap, set_logdir)
from lib.driver.core.settings import Settings as ST
from lib.driver.utils.compat import script_log_dir
...
def auto_setup(basedir=None, devices=None, logdir=None, project_root=None, compress=None):
    ...
    :param devices: connect_device uri in _list.
    ...
    :Example:
        ...
        * ``Android``: it is equivalent to executing ``adb shell input keyevent KEYNAME`` ::
        ...
        .. seealso::
           ...
           Module :py:mod:`driver.core.android.adb.ADB.keyevent`
        ...
        * ``Windows``: Use ``pywinauto.keyboard`` module for key input::
        ...
        .. seealso::
            ...
            Module :py:mod:`driver.core.win.win.Windows.keyevent`
...
def text(text, enter=True, **kwargs):
    ...
    :Example:
        ...
        .. seealso::
            ...
            Module :py:mod:`driver.core.android.ime.YosemiteIme.code`
...
def exists(v, threshold=None):
    ...
    """
    try:
        pos = loop_find(v, threshold=threshold, timeout=ST.FIND_TIMEOUT_TMP)
...
def find_all(v):
    ...
    :return: _list of results, [{'result': (x, y),
