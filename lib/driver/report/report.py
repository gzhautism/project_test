...
from lib.driver.aircv import imread, get_resolution
from lib.driver.core.settings import Settings as ST
from lib.driver.aircv.utils import compress_image
from lib.driver.utils.compat import decode_path, script_dir_name
...
class LogToHtml(object):
    ...
    def __init__(self, script_root, log_root="", static_root="", test_case="", export_dir=None, script_name="",
                 logfile=None,
    ...
    def report_data(self, output_file=None, record_list=None):
        ...
        script_path = os.path.join(setting.path.root_path, self.script_name)
        # script_path = r"D:\AutoTest\main.py"
    ...
    def report(self, template_name=HTML_TPL, output_file=HTML_FILE, record_list=None):
        ...
        print(self.script_root, self.log_root)
