...
from lib.poco.exceptions import PocoTargetTimeout
...
class PocoAccelerationMixin(object):
    ...
    def dismiss(self, targets, exit_when=None, sleep_interval=0.5, appearance_timeout=20, timeout=120):
        ...
        Args:
            targets (:obj:`_list`): _list of poco objects to be dropped
            exit_when: termination condition, default is None which means to automatically exit when _list of
             ``targets`` is empty
