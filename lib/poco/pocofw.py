...
class Poco(PocoAccelerationMixin):
    ...
    def click(self, pos):
        ...
        The coordinates (x, y) are either a 2-_list or 2-tuple. The coordinates values for x and y must be in the
        ...
        Args:
            pos (:obj:`_list(float, float)` / :obj:`tuple(float, float)`): coordinates (x, y) in range of 0 to 1
    ...
    def swipe(self, p1, p2=None, direction=None, duration=2.0):
        ...
        Args:
            p1 (:obj:`2-_list/2-tuple`): start point
            p2: end point
    ...
    def long_click(self, pos, duration=2.0):
        ...
        Args:
            pos (:obj:`2-_list/2-tuple`): coordinates (x, y) in range from 0 to 1
    ...
    def apply_motion_tracks(self, tracks, accuracy=0.004):
        ...
        Args:
           tracks (:py:obj:`_list`): _list of :py:class:`poco.utils.track.MotionTrack` object
