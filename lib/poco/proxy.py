...
import math
import copy
import lib.poco.utils.six as six
import time
from functools import wraps

from lib.poco.gesture import PendingGestureAction
from lib.poco.exceptions import PocoTargetTimeout, InvalidOperationException, PocoNoSuchNodeException, PocoTargetRemovedException
from lib.poco.sdk.exceptions import UnableToSetAttributeException
from lib.poco.utils.query_util import query_expr, build_query
from lib.poco.utils.multitouch_gesture import make_pinching
...
class UIObjectProxy(object):
    ...
    def click(self, focus=None, sleep_interval=None):
        ...
        Args:
            focus (2-:obj:`tuple`/2-:obj:`_list`/:obj:`str`): an offset point (x, y) from the top left corner of the UI
    ...
    def swipe(self, direction, focus=None, duration=0.5):
        ...
        Args:
            direction (2-:obj:`tuple`/2-:obj:`_list`/:obj:`str`):  coordinates (x, y) in NormalizedCoordinate system, it
             ...
             to [0.1, 0]
            focus (2-:obj:`tuple`/2-:obj:`_list`/:obj:`str`): see :py:meth:`.click() <poco.proxy.UIObjectProxy.click>`
             for more details
    ...
    def drag_to(self, target, duration=2.0):
        ...
        Args:
            target (:py:class:`UIObjectProxy <poco.proxy.UIObjectProxy>`): a UI proxy or 2-_list/2-tuple coordinates
    ...
    def focus(self, f):
        ...
        Args:
            f (2-:obj:`tuple`/2-:obj:`_list`/:obj:`str`): the focus point, it can be specified as 2-_list/2-tuple
    ...
    def get_position(self, focus=None):
        ...
        Returns:
            2-_list/2-tuple: coordinates (x, y) in NormalizedCoordinate system
        ...
        if focus == 'anchor':
            ...
            raise TypeError('Unsupported focus type {}. '
                            'Only "anchor/center" or 2-_list/2-tuple available.'.format(type(focus)))
        return pos
    ...
    def _direction_vector_of(self, dir_):
        if dir_ == 'up':
            ...
            raise TypeError('Unsupported direction type {}. '
                            'Only "up/down/left/right" or 2-_list/2-tuple available.'.format(type(dir_)))
        return dir_vec
    ...
    def get_size(self):
        ...
        Returns:
            2-:obj:`_list`: size [width, height] in range of 0 ~ 1.
        """
    ...
    def get_bounds(self):
        ...
        Returns:
            :obj:`_list` <:obj:`float`>: 4-_list (top, right, bottom, left) coordinates related to the edge of screen in
