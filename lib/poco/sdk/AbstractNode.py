...
class AbstractNode(object):
    ...
    def getAttr(self, attrName):
        """
        Return the attributes of the node. The _list below shows the most used basic attributes used during while writing
        ...
        - ``pos``: position of the node in screen, return value should be 2-_list coordinates (x, y) representing
        ...
        - ``size``: size of the node bounding box, similar to ``pos``, value is also a 2-_list of the percentage of
        ...
        - ``anchorPoint``: 2-_list coordinates (x, y) of the anchor expressed in the percentage related to the bounding
    ...
    def setAttr(self, attrName, val):
        """
        Apply changes of the attribute value to this node. Not all attributes can be modified. The most utils
