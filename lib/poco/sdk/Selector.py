...
class ISelector(object):
    ...
    def select(self, cond, multiple=False):
        ...
        Returns:
            :obj:`_list`: _list <inherited from :py:class:`AbstractNode <poco.sdk.AbstractNode>`>
        """
...
class Selector(ISelector):
    ...
    def selectImpl(self, cond, multiple, root, maxDepth, onlyVisibleNode, includeRoot):
        ...
        Returns:
            :obj:`_list` <inherited from :py:class:`AbstractNode <poco.sdk.AbstractNode>`>: The same as
        ...
        if op in ('>', '/'):
            ...
            cond, i = args
            try:
                # set multiple=True, self.selectImpl will return a _list
