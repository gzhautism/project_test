...
from lib.driver.core.api import device as current_device
from lib.driver.core.api import touch, swipe
from lib.driver.core.helper import device_platform, logwrap
from lib.poco.sdk.interfaces.input import InputInterface
...
class DriverInput(InputInterface):
    def __init__(self):
        super(DriverInput, self).__init__()
    ...
    def applyMotionEvents(self, events):
        ...
        from lib.driver.core.android.touch_methods.base_touch import DownEvent, MoveEvent, UpEvent, SleepEvent
